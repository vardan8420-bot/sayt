		...
		if (session) {
			return (
				<div className={styles.compactContainer}>
					<Link href="/dashboard" className={styles.compactUser}>
						{session.user?.image && (
							<Image
					...
					<button
						className={styles.compactSignOut}
						onClick={() => signOut()}
						aria-label={t('Выйти', 'Sign Out', 'Ելք', 'გასვლა')}
					>
						{t('Выйти', 'Sign Out', 'Ելք', 'გასვლა')}
					</button>
				</div>
			)
		}
		...
		<div className={styles.container}>
			...
			<div className={styles.buttons}>
				...
				>
					...
					{t('Войти через GitHub', 'Sign in with GitHub', 'Մուտք GitHub-ով', 'შესვლა GitHub-ით')}
				</button>
				<button
				...
				>
					...
					{t('Войти через Google', 'Sign in with Google', 'Մուտք Google-ով', 'შესვლა Google-ით')}
				</button>
			</div>
		</div>
	)
